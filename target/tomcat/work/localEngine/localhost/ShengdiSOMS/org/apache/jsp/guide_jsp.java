...
public final class guide_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t<li><a href=\"login.jsp\" target=\"contentframe\"> <i\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t<li><a href=\"customerreadAllByServicePersonnel.action\" target=\"contentframe\"><i\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tclass=\"glyphicon glyphicon-user\"></i>客户管理</a></li>\r\n");
      out.write("\t\t\t\t\t\t\t\t<li><a href=\"priceManagementAction!listAll.action\" target=\"contentframe\"><i class=\"glyphicon glyphicon-th-list\"></i>价格表管理</a></li>\r\n");
      ...
      out.write("                                <i class=\"glyphicon glyphicon-credit-card\"></i>系统设置</a>\r\n");
      ...
      out.write("                                 <li><a href=\"priceAllocationAction!list.action\" target=\"contentframe\"><i \r\n");
      out.write("                                 \t\tclass=\"glyphicon glyphicon-asterisk\"></i>价格表配置</a></li>\r\n");
      ...
      out.write("\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t<li><a href=\"#userManager\" data-toggle=\"collapse\"\r\n");
      out.write("\t\t\t\t\t\t\taria-expanded=\"true\" class=\"nav-header collapsed hasdown\"\r\n");
      out.write("\t\t\t\t\t\t\taria-controls=\"userManager\"><span\r\n");
      out.write("\t\t\t\t\t\t\t\tclass=\"pull-right glyphicon glyphicon-chevron-right\"></span> <i\r\n");
      out.write("\t\t\t\t\t\t\t\tclass=\"glyphicon glyphicon-user\"></i> 用户管理 </a>\r\n");
      out.write("\t\t\t\t\t\t\t<ul id=\"userManager\" class=\"nav nav-list collapse secondmenu\"\r\n");
      out.write("\t\t\t\t\t\t\t\tstyle=\"height: 0px; padding-left: 30px\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<li><a href=\"userAction!listUser.action\" target=\"contentframe\"><i\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tclass=\"glyphicon glyphicon-user\"></i>账号管理</a></li>\r\n");
      out.write("\t\t\t\t\t\t\t\t<li><a href=\"#\"><i class=\"glyphicon glyphicon-th-list\"></i>角色权限管理</a></li>\r\n");
      out.write("\t\t\t\t\t\t\t</ul>\r\n");
      out.write("\t\t\t\t\t\t<li><a href=\"#\"> <i\r\n");
      out.write("\t\t\t\t\t\t\t\tclass=\"glyphicon glyphicon-credit-card\"></i> 报表管理\r\n");
      out.write("\t\t\t\t\t\t</a></li>\r\n");
      out.write("\t\t\t\t\t</ul>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t</div>\r\n");
