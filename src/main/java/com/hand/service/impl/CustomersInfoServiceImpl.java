...
public class CustomersInfoServiceImpl implements CustomersInfoService {
	...
	public List<CustomersInfo> inquireAll(String cust_name,String type,String group_company,
		...
		return customersInfoDao.inquireAll(cust_name, type, group_company, cust_code, status, corporation);
	...
	public List<CustomersInfo> inquireAllByServicePersonnel(String cust_name,String type,String group_company,
		...
		return customersInfoDao.inquireAllByServicePersonnel(cust_name, type, group_company, cust_code, status, corporation);
	...
	public List<CustomersInfo> readAllByServicePersonnel() {
		...
		return customersInfoDao.readAllByServicePersonnel();
	}
