...
<body>
	<div class="container">
		<div id="add-find-form" class="col-md-12">
			<form action="specialDiscountAction!findByCondition.action" method="post">
				<label class="col-md-2">折扣名称</label>
				<input class="col-md-3" type="text" name="specialDiscount.discount_name"/>
				<label class="col-md-2">客户代码</label>
				<input class="col-md-3" type="text" name="specialDiscount.cust_code" />
				<div class="add_find col-md-12">
					<button onclick="location.href='addSpecialDiscount.jsp'" type="button" class="btn btn-default col-md-1 col-md-offset-4">新增</button>
