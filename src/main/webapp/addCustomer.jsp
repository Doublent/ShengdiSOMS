				...
				<div>
					<div id="address">
						...
						<form action="customercreate.action" method="post">
							...
							<p>
								<span style="text-decoration: underline;">基本信息</span>
							</p>
							<div class="divheight">
								<div class="col-md-2 col-md-offset-1 text">*客户名称</div>
								<div class="col-md-9 inputtext">
									<input type="text" name="cust_name" />
								</div>
							</div>
							<div class="divheight">
								<div class="col-md-2 col-md-offset-1 text">*客户简称</div>
								<div class="col-md-9 inputtext">
									<input type="text" name="cust_code" />
								</div>
							</div>
							<div class="divheight">
								<div class="col-md-2 col-md-offset-1 text">*类型</div>
								<div class="col-md-9 inputtext">
									<input type="text" name="type" />
								</div>
							</div>
							<div class="divheight">
								<div class="col-md-2 col-md-offset-1 text">集团公司</div>
								<div class="col-md-9 inputtext">
									<input type="text" name="group_company" />
								</div>
							</div>
							<div class="divheight">
								<div class="col-md-2 col-md-offset-1 text">总公司</div>
								<div class="col-md-9 inputtext">
									<input type="text" name="Corporation" />
								</div>
							</div>
							...
							<div class="divheight">
								...
								<div class="col-md-9 inputtext">
									<input id="u125_input" type="text" value="待确认"
										readonly="readonly" style="color: gray;" name="status" />
								</div>
							</div>
							<br> <br> <br>
